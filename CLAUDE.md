...
- **Commands**: unit `npm test` · E2E `npm run test:e2e` · merged coverage `npm run test:all` · CI-parity E2E in Docker `npm run test:e2e:docker` · feature coverage `npm run check:features` · lint `npm run lint` · types `npm run typecheck`.
