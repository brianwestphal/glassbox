...
- `demo:capture` — regenerate the animated README hero `assets/demo.svg` (+
  ...
  `domotion-svg` is pinned to 0.5.0 and forced to embedded-font text mode
