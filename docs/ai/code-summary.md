...
| `noteMarkdown.ts` | `renderNoteMarkdown` — safe, escape-first inline markdown renderer (code/bold/italic/scheme-gated links) shared by AI review notes + the risk/narrative/guided notes. |
